"""Compatibility entrypoint for seeding the built-in incident-triage example."""
...
async def ensure_demo_runs(
    ...
    await ensure_incident_demo_runs(session_factory, runner, default_scoring_registry())
