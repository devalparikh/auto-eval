      ...
      {open ? (
        ...
        >
          <motion.div
            ...
            className="max-h-[88dvh] w-full max-w-[560px] overflow-y-auto rounded-[var(--radius)] border border-[var(--border-strong)] bg-[var(--surface-raised)] shadow-[0_28px_90px_rgba(0,0,0,0.45)]"
          ...
          >
            <div className="flex items-start justify-between gap-4 border-b border-[var(--border)] px-5 py-4">
              <div>
                ...
                {description ? (
                  <p id="modal-description" className="mt-1 text-[11px] text-[var(--text-muted)]">
                    {description}
                  </p>
                ) : null}
              </div>
